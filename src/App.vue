...
<template>
  <div class="menu-wrapper">
    <a-menu
      ...
      theme="dark"
    >
      <a-menu-item  width="280px" class="home">
        label-helper图像标注平台
      </a-menu-item>
      <a-menu-item key="home" width="80px"> 首页 </a-menu-item>
      <a-sub-menu width="80px">
        <template #title>我的任务</template>
        <a-menu-item key="myPub" class="inner-menu">我的发布</a-menu-item>
        <a-menu-item key="myRec" class="inner-menu">我的领取</a-menu-item>
      </a-sub-menu>
      <a-sub-menu width="80px">
        <template #title>标注任务</template>
      ...
      <a-menu-item class="personal" width="180px" key="personal">
        <div class="login-status" width="180px">登录/退出</div>
      </a-menu-item>
    </a-menu>
  </div>
